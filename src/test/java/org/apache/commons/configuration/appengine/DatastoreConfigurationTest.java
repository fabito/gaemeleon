...
public class DatastoreConfigurationTest {
    ...
    private Map<String, String> initialConfiguration = ImmutableMap.<String, String>of(
    		"p1", "v1",
    		"p2", "v2",
    		"p3", "v3",
    		"p4", "v4"
	...
	public void getKeysShouldReturnRightValue() {
		...
		while( iterator.hasNext() ) {
			  ...
			  assertThat(initialConfiguration.keySet(), hasItem(e));
			  counter++;
		}
		assertThat(counter, is(initialConfiguration.size()));
	}
    ...
    private void addConfiguration(String key, String value) {
        Entity configurationEntity = new Entity(DatastoreConfiguration.DEFAULT_ENTITY_KIND, key);
        configurationEntity.setUnindexedProperty(DatastoreConfiguration.DEFAULT_PROPERTY_VALUE, value);
